...
const SUGGESTED_PROMPTS = [
  { icon: '📋', label: 'Summarize', text: 'Summarize the key points of this document' },
  { icon: '🔍', label: 'Deep dive', text: 'What are the main arguments and supporting evidence?' },
  { icon: '💡', label: 'Key insights', text: 'What are the most important insights or findings?' },
  { icon: '❓', label: 'Questions', text: 'What questions does this document raise?' },
];
...
const SourceBadge = ({ index, onClick }: { index: number; onClick: () => void }) => (
  <button
    onClick={onClick}
    style={{
      display: 'inline-flex',
...
// ─── Empty State ──────────────────────────────────────────────────────────────
const EmptyState = ({ onPromptClick }: { onPromptClick: (text: string) => void }) => (
  <div style={{
    display: 'flex',
    flexDirection: 'column',
    alignItems: 'center',
    ...
    <div>
      ...
      <p style={{
        ...
        Ask questions about your uploaded PDFs and get answers with source citations.
      </p>
    </div>
            ...
            {isLoading && (
              <div style={{ maxWidth: '720px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '4px' }}>
                  ...
                  <span style={{ fontSize: '12px', fontWeight: 600, color: 'var(--text-tertiary)', textTransform: 'uppercase', letterSpacing: '0.3px' }}>
                    Researching...
                  </span>
                </div>
        ...
        <form
          ...
          onBlur={(e) => {
            if (!e.currentTarget.contains(e.relatedTarget)) {
              (e.currentTarget as HTMLFormElement).style.borderColor = 'var(--border-default)';
            }
          }}
        >
          <textarea
